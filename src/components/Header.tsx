                ...
                <nav className="flex flex-col space-y-4">
                  {menuItems.map((item) => (
                    <button
                      key={item.id}
                      onClick={() => scrollToSection(item.id)}
                      className="text-left text-gray-700 hover:text-blue-500 font-medium py-2 transition-colors text-base"
                    >
                      {item.label}
                    </button>
                  ))}
                  <div className="pt-4 border-t border-gray-200">
                    <div className="flex items-center space-x-2 text-gray-700 mb-2">
                      <Phone size={16} />
                      <span className="text-base">+7 (840) 123-456</span>
                    </div>
                    <div className="flex items-center space-x-2 text-gray-600">
                      <MapPin size={16} />
                      <span className="text-base">Сухум, Абхазия</span>
                    </div>
                  </div>
                </nav>
              </div>
